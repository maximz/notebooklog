#!/usr/bin/env python
#
# nblog documentation build configuration file, created by sphinx-quickstart.
#
...
version = nblog.__version__
# The full version, including alpha/beta/rc tags.
release = nblog.__version__
...
def linkcode_resolve(domain, info):
    def find_source():
        ...
        fn = os.path.relpath(fn, start=os.path.dirname(nblog.__file__))
    ...
    if domain != "py" or not info["module"]:
        return None
    try:
        filename = "nblog/%s#L%d-L%d" % find_source()
    except Exception:
    ...
    return "https://github.com/maximz/nblog/blob/%s/%s" % (tag, filename)
